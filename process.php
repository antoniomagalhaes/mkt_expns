...
$requiredFields = array(
	...
	'localidade' => 'Insira a sua localidade.',
...
$subject = "Simulador Market Expanssion LeasePlan GO" ;

$messageBody = "
Agradecemos o seu interesse e queremos ajudá-lo optimizar a sua frota .
...
$subject = "Simulador Market Expanssion";

$messageBody = "
" . $nome . "Pedido de Relatório - Prospect com os seguintes dados:
...
$recipientemail= "contacto@antpniomagalhaes.com";

$reg_emailed = "NO";

ini_set('sendmail_from', 'contacto@antpniomagalhaes.com');
